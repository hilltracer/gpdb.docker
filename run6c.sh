...
mkdir -p /tmp/data/6c /tmp/data/6c.test
docker run \
    --detach \
    ...
    --mount type=bind,source=/tmp/data/6c,destination=/home/gpadmin/.data \
    --mount type=bind,source=/tmp/data/6c.test,destination=/home/gpadmin/gpdb_src/src/test \
